...
const Footer = () => {
  const handleButtonClick = (input) => {
    switch (input) {
      case 1:
        return window.open(
          "https://www.linkedin.com/in/thinira-genuka/",
          "_blank"
        );
      case 2:
  ...
  return (
    <div
      id="contact"
      className="w-full py-20 h-auto border-b-[1px] border-b-black grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-3 gap-8"
    >
      ...
      <div className="w-full h-full">
        ...
        <ul className="flex flex-col gap-4 font-titleFont font-medium py-6 overflow-hidden">
          <li>
            <span className="w-full text-lg relative hover:text-designColor duration-300 group ">
